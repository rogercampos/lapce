# This Makefile is intended *only* for building macOS binaries of SourceDelve.
...
app: $(APP_NAME)-native ## Create a SourceDelve.app
app-universal: $(APP_NAME)-universal ## Create a universal SourceDelve.app
$(APP_NAME)-%: $(TARGET)-%
	...
	xattr -c $(APP_DIR)/$(APP_NAME)/Contents/Resources/sourcedelve.icns
...
dmg: $(DMG_NAME)-native ## Create a SourceDelve.dmg
dmg-universal: $(DMG_NAME)-universal ## Create a universal SourceDelve.dmg
$(DMG_NAME)-%: $(APP_NAME)-%
